...
const GrayButton = ({ name }: { name: string }) => {
  return (
    <div className=" relative inline-flex justify-center items-center bg-gray-900/30 backdrop-blur-md shadow-lg rounded-full 
      ...
      <div className="group-hover:bg-gray-400/60 transition-all duration-300 ease-in-out absolute inset-0 rounded-full p-[1px] bg-gradient-to-b from-transparent via-white/10 to-gray-400/70 transition-all duration-300 group-hover:bg-transparent">

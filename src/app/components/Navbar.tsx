    ...
    <nav className="fixed top-0 left-1/2 -translate-x-1/2 z-50 w-full">
      <div className="px-12 py-5 font-rethink">
        <ul className="flex items-center justify-between w-full">
          ...
          <div className="relative flex justify-center items-center  mx-auto bg-gray-900/30 backdrop-blur-md shadow-lg rounded-full py-2 px-6">
            ...
            <div className="relative flex items-center space-x-6">
              <li className="border-r border-gray-500/30 pr-6">
                <Link to="/" className="flex items-center text-gray-300 hover:text-white transition-colors text-lg">
                  <span>Accueil</span>
                </Link>
              </li>
              <li className="border-r border-gray-500/30 pr-6">
                <Link to="/pricing" className="flex items-center text-gray-300 hover:text-white transition-colors text-lg">
                  <span>Tarifs</span>
                </Link>
              </li>
              <li>
                <Link to="/faq" className="flex items-center text-gray-300 hover:text-white transition-colors text-lg">
                  <span>FAQ</span>
                </Link>
              </li>
            </div>
          ...
          {/* Contact à droite */}
          <li>
            <Link to="/contact" className="flex items-center text-gray-300 hover:text-white transition-colors text-lg">
              <span>Contact</span>
            </Link>
          </li>
        </ul>

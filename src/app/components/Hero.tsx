...
const Hero = () => {
  ...
  return (
    <header id='home' data-aos="fade-up" className="relative container mx-auto px-4 py-[200px] sm:py-[90px] md:py-[100px] lg:py-[150px] text-center">
      {/* Contenu du Hero */}
      <h1 data-aos="fade-up" className="relative text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-b from-white to-gray-500 text-transparent bg-clip-text font-light text-shadow z-10 overflow-hidden">
        Je Délivre Des SaaS <br /> à Croissance Exponentielle.
      </h1>
      <p data-aos="fade-up" className="relative text-lg sm:text-xl text-white max-w-2xl mx-auto font-light z-10 text-gray-200/50">

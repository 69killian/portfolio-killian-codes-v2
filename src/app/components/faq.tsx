...
export default function FAQ() {
  ...
  const faqs = [
    {
      question: "Depuis combien d'années faites-vous du développpement web ?",
      answer:
        "Je suis dans le développement web depuis 4 ans, j'ai commencé par apprendre le développement web en autodidacte, puis j'ai suivi une formation pour devenir développeur web.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Oui, je suis ouvert aux missions de longue durée selon les besoins du client.",
    },
    {
  ...
  return (
    <>
      <div
        id="faq"
        data-aos="fade up"
        className="pt-24 font-rethink pb-[150px]"
      >
        <div className="container mx-auto px-4 py-16 flex flex-col md:flex-row items-start justify-between">
          ...
          <div className="w-full md:w-2/3 pr-8 mb-10">
            ...
            <h2
              data-aos="fade up"
              className="relative text-4xl sm:text-5xl md:text-6xl lg:text-6xl font-bold bg-gradient-to-b from-white to-gray-500 text-transparent bg-clip-text font-rethink text-shadow z-10 overflow-hidden"
            >
              Toutes Les Réponses Dont Vous Avez Besoin.
            </h2>
            <p
              data-aos="fade up"
              className="relative text-lg sm:text-xl text-white max-w-2xl mx-auto font-rethink z-10 text-gray-200/50"
            >
              Que vous soyez à la recherche d&apos;aide pour une commande, ou de
              solutions à vos questions fréquentes, cette section est conçue
              pour vous fournir des informations claires et complètes.
            </p>
          </div>
            ...
            <div className="max-w-2xl mx-auto space-y-4">
              {faqs.map((faq, index) => (
                  ...
                  style={
                    {
                      ...
                      "--bg-color":
                        "linear-gradient(rgb(var(--background)), rgb(var(--background)))", // Gradient de fond
                ...
                >
                  ...
                  {activeFaq === index && (
                    <div className="px-6 pb-4 text-gray-400 relative z-10">
                      {faq.answer}
                    </div>
                  )}
                </div>
